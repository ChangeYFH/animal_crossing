<template>
  <div class="fish-page">
    <mine-filter @search="refreshList" category="fish" :conditions="conditions" :list="list"></mine-filter>
  ...
  export default {
    ...
    methods:{
      ...
      getData(){
        ...
        Vue.http.get("http://62.234.172.175:3000/fish",config).then(res => {
